  ...
  return (
    <div className="min-h-screen w-full bg-muted flex">
      ...
      <main className="flex-1  min-w-0 md:ml-47 lg:ml-64 px-5 py-8 md:p-8">
        ...
        />
        <div className="bg-background rounded-xl border-x border-t md:border-border border-border mt-4">
          ...
          <div className="flex flex-col lg:hidden">
            {assignedMembers.map((member) => (
              <div
                key={member.id}
                className="border-b border-gray-200 p-3.5 text-[11px] font-medium uppercase tracking-wide"
              >
                <div className="flex items-center justify-between">
                  <span className="text-sm normal-case font-semibold text-gray-900">
                    {member.full_name}
                  </span>
                  <span
                    className={
                      member.active ? "text-verde-kurve" : "text-gray-400"
                    }
                  >
                ...
                <div className="mt-2 flex flex-col gap-1 text-gray-500">
